...
%prep
%setup -q -n identify-2.3.3
cd %{_builddir}/identify-2.3.3
...
cp %{_builddir}/identify-2.3.3/LICENSE %{buildroot}/usr/share/package-licenses/identify/428ea02ecbdb18e260e938e24a83f8d96b7def89
