...
Version  : 2.3.7
Release  : 20
URL      : https://files.pythonhosted.org/packages/db/0c/de2172615bfd47a645890b5b2e80c8318855aea6d210ef1e6fa3ceb550a5/identify-2.3.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/db/0c/de2172615bfd47a645890b5b2e80c8318855aea6d210ef1e6fa3ceb550a5/identify-2.3.7.tar.gz
...
%prep
%setup -q -n identify-2.3.7
cd %{_builddir}/identify-2.3.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637252037
...
cp %{_builddir}/identify-2.3.7/LICENSE %{buildroot}/usr/share/package-licenses/identify/428ea02ecbdb18e260e938e24a83f8d96b7def89
