...
Version  : 2.3.2
Release  : 14
URL      : https://files.pythonhosted.org/packages/ba/e1/007884dfe15fc32c9f40eb8fc054b35f4ce9ea2fbdcd2b4fb5b182f55c8a/identify-2.3.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/ba/e1/007884dfe15fc32c9f40eb8fc054b35f4ce9ea2fbdcd2b4fb5b182f55c8a/identify-2.3.2.tar.gz
...
%prep
%setup -q -n identify-2.3.2
cd %{_builddir}/identify-2.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635639664
...
cp %{_builddir}/identify-2.3.2/LICENSE %{buildroot}/usr/share/package-licenses/identify/428ea02ecbdb18e260e938e24a83f8d96b7def89
