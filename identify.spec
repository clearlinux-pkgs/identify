...
Source0  : https://files.pythonhosted.org/packages/e1/c1/4e0085274e65780e889f00ea01be6b80d47500f58617ef0489c940158fa8/identify-2.4.0.tar.gz
...
%prep
%setup -q -n identify-2.4.0
cd %{_builddir}/identify-2.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637366933
...
cp %{_builddir}/identify-2.4.0/LICENSE %{buildroot}/usr/share/package-licenses/identify/428ea02ecbdb18e260e938e24a83f8d96b7def89
