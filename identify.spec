...
Source0  : https://files.pythonhosted.org/packages/e7/2c/3f6822048d64c62df153b26bb91d8d3a7e8fbd08ee57f9d55dd6a2d3548a/identify-2.3.1.tar.gz
...
%prep
%setup -q -n identify-2.3.1
cd %{_builddir}/identify-2.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635115662
...
cp %{_builddir}/identify-2.3.1/LICENSE %{buildroot}/usr/share/package-licenses/identify/428ea02ecbdb18e260e938e24a83f8d96b7def89
