...
Version  : 2.3.4
Release  : 17
URL      : https://files.pythonhosted.org/packages/bf/25/d5b05544552b6a55905a18ca609d553e02771d5383151671c18f976b91b9/identify-2.3.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/bf/25/d5b05544552b6a55905a18ca609d553e02771d5383151671c18f976b91b9/identify-2.3.4.tar.gz
...
%prep
%setup -q -n identify-2.3.4
cd %{_builddir}/identify-2.3.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636386126
...
cp %{_builddir}/identify-2.3.4/LICENSE %{buildroot}/usr/share/package-licenses/identify/428ea02ecbdb18e260e938e24a83f8d96b7def89
