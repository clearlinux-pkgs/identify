...
Source0  : https://files.pythonhosted.org/packages/60/7e/b8af97e380d57ff850d13b85473545a2229ec31d71ee04337610fe313e84/identify-2.2.13.tar.gz
...
%prep
%setup -q -n identify-2.2.13
cd %{_builddir}/identify-2.2.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628529531
...
cp %{_builddir}/identify-2.2.13/LICENSE %{buildroot}/usr/share/package-licenses/identify/428ea02ecbdb18e260e938e24a83f8d96b7def89
