...
Version  : 2.3.5
Release  : 18
URL      : https://files.pythonhosted.org/packages/63/ca/9babe24b165e266032dfe7eeab7b5fc0f024eeb47e36e82d9d2fc63294e3/identify-2.3.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/63/ca/9babe24b165e266032dfe7eeab7b5fc0f024eeb47e36e82d9d2fc63294e3/identify-2.3.5.tar.gz
...
%prep
%setup -q -n identify-2.3.5
cd %{_builddir}/identify-2.3.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636473001
...
cp %{_builddir}/identify-2.3.5/LICENSE %{buildroot}/usr/share/package-licenses/identify/428ea02ecbdb18e260e938e24a83f8d96b7def89
